const App = {
  ...
  computed: {
    stepText() {
      return this.completed ? this.steps[this.steps.length - 1].text : this.steps[this.activeIndex].text
    },
    ...
    nextOrFinishButtonText() {
      return this.isLastStep ? 'Закончить' : 'Вперёд'
    },
